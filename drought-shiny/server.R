...
shinyServer(function(input, output) {
   ...
   ## Minima ----
    ...
    output$model_effect_summer_1 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_summer_20203, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 1, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_summer_20203, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_summer_10304, select = 1, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 1, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 2 ----
    output$model_effect_summer_2 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_summer_20203, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 2, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 2, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 2, ylim = c(-7, 7))
        }
    ...
    output$model_effect_summer_3 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_summer_20203, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 3, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_summer_20203, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_summer_10304, select = 3, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 3, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 4 ----
    output$model_effect_summer_4 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_summer_20203, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 4, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_summer_20203, select = 4, ylim =c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_summer_10304, select = 4, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 4, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 5 ----
    output$model_effect_summer_5 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_summer_20203, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 5, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_summer_20203, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_summer_10304, select = 5, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 5, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 6 ----
    output$model_effect_summer_6 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_summer_20203, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 6, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_summer_20203, select = 6, ylim = c(-7, 7))  
          }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 6, ylim = c(-7, 7))     
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
      ...
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 6, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 7 ----
    output$model_effect_summer_7 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 7, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
        }
      }
      ...
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_summer_10304, select = 7, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 8 ----
    output$model_effect_summer_8 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 8, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 8, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_summer_11502, select = 8, ylim = c(-7, 7))
      ...
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_summer_20203, select = 8, ylim = c(-7, 7))
          
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 8, ylim = c(-7, 7))
    ...
    output$model_effect_summer_9 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 9, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 9, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
      ...
      if (input$model_selection %in% "Interactions") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 9, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
    ...
    ###### Full Model ----
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_summer_11502, select = 10, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_summer_10304, select = 10, ylim = c(-7, 7))
        }}
    ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
    ...
    output$model_effect_winter_1 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 1, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_winter_20203, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_summer_10304, select = 1, ylim = c(-7, 7))
        }
      ...
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 1, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 1, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 2 ----
    output$model_effect_winter_2 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 2, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_winter_20203, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_summer_10304, select = 2, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 2, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 2, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 3 ----
    output$model_effect_winter_3 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 3, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_winter_20203, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_winter_10304, select = 3, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 3, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 3, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 4 ----
    output$model_effect_winter_4 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 4, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_winter_20203, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_winter_10304, select = 4, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 4, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 4, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 5 ----
    output$model_effect_winter_5 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 5, ylim = c(-30, 30))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 5, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_winter_20203, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_winter_10304, select = 5, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 5, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 5, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 6 ----
    output$model_effect_winter_6 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 6, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_winter_20203, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_winter_10304, select = 6, ylim = c(-7, 7))
        }
      }
      ##### Interactions ----
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_summer_11502, select = 6, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 6, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 7 ----
    output$model_effect_winter_7 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam2_all_winter_20203, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 7, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 7, ylim = c(-7, 7))
      ...
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 7, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 7, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 8 ----
    output$model_effect_winter_8 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 8, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 8, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_trimmed_winter_11502, select = 8, ylim = c(-7, 7))
      ...
      if (input$model_selection %in% "Interactions") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
          plot(gam_selected_interact_winter_20203, select = 8, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 8, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_selected_interac_winter_10304, select = 8, ylim = c(-7, 7))
        }
      }
    })
    #### Effect Plot 9 ----
    output$model_effect_winter_9 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 9, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 9, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
      ...
      if (input$model_selection %in% "Interactions") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 9, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
        }
      }
    ...
    output$model_effect_winter_10 <- renderPlot({
      ...
      if (input$model_selection %in% "Full Model") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_all_winter_11502, select = 10, ylim = c(-7, 7))
        }
        if (input$model_catchment %in% "Isar Mittenwald") {
          plot(gam_all_winter_10304, select = 10, ylim = c(-7, 7))
        }}
      ##### Trimmed Model ----
      if (input$model_selection %in% "Trimmed Model") {
        if(input$model_catchment %in% "Fränkische Saale Salz"){
      ...
      if (input$model_selection %in% "Interactions") {
        ...
        if (input$model_catchment %in% "Iller Kempten") {
          plot(gam_interactions_winter_11502, select = 10, ylim = c(-7, 7))
